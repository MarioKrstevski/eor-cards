          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {filteredCards.length > 0 && (
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium rounded-lg border bg-violet-50 text-violet-700 border-violet-200 hover:bg-violet-100 transition-colors duration-150"
                title="Review cards Anki-style"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
